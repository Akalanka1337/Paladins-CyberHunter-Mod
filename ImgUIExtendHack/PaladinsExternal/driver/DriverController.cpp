...
unsigned __int32 DriverController::GetProcessPidByName(const char* ProcessName)
{
	PROCESSENTRY32 pt;
...
bool DriverController::ResetProcessId(const char* TargetProcessName)
{
...
DriverController::DriverController(const char* TargetProcessName)
{
	DriverHandle = INVALID_HANDLE_VALUE;
